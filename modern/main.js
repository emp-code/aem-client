...
function getCountryName(countryCode) {
	switch (countryCode) {
		case "DZ": return "Africa/Algeria";
		case "AO": return "Africa/Angola";
		case "BJ": return "Africa/Benin";
		case "BW": return "Africa/Botswana";
		case "BF": return "Africa/Burkina Faso";
		case "BI": return "Africa/Burundi";
		case "CV": return "Africa/Cabo Verde";
		case "CM": return "Africa/Cameroon";
		case "CF": return "Africa/Central African Republic";
		case "TD": return "Africa/Chad";
		case "KM": return "Africa/Comoros";
		case "CD": return "Africa/Congo";
		case "DJ": return "Africa/Djibouti";
		case "EG": return "Africa/Egypt";
		case "GQ": return "Africa/Equatorial Guinea";
		case "ER": return "Africa/Eritrea";
		case "SZ": return "Africa/Eswatini";
		case "ET": return "Africa/Ethiopia";
		case "GA": return "Africa/Gabon";
		case "GM": return "Africa/Gambia";
		case "GH": return "Africa/Ghana";
		case "GW": return "Africa/Guinea-Bissau";
		case "GN": return "Africa/Guinea";
		case "CI": return "Africa/Ivory Coast";
		case "KE": return "Africa/Kenya";
		case "LS": return "Africa/Lesotho";
		case "LR": return "Africa/Liberia";
		case "LY": return "Africa/Libya";
		case "MG": return "Africa/Madagascar";
		case "MW": return "Africa/Malawi";
		case "ML": return "Africa/Mali";
		case "MR": return "Africa/Mauritania";
		case "MU": return "Africa/Mauritius";
		case "YT": return "Africa/Mayotte";
		case "MA": return "Africa/Morocco";
		case "MZ": return "Africa/Mozambique";
		case "NA": return "Africa/Namibia";
		case "NE": return "Africa/Niger";
		case "NG": return "Africa/Nigeria";
		case "CG": return "Africa/Republic of the Congo";
		case "RW": return "Africa/Rwanda";
		case "RE": return "Africa/Réunion";
		case "SH": return "Africa/Saint Helena";
		case "SN": return "Africa/Senegal";
		case "SC": return "Africa/Seychelles";
		case "SL": return "Africa/Sierra Leone";
		case "SO": return "Africa/Somalia";
		case "ZA": return "Africa/South Africa";
		case "SS": return "Africa/South Sudan";
		case "SD": return "Africa/Sudan";
		case "ST": return "Africa/São Tomé and Príncipe";
		case "TZ": return "Africa/Tanzania";
		case "TG": return "Africa/Togo";
		case "TN": return "Africa/Tunisia";
		case "UG": return "Africa/Uganda";
		case "EH": return "Africa/Western Sahara";
		case "ZM": return "Africa/Zambia";
		case "ZW": return "Africa/Zimbabwe";
		case "AQ": return "Antarctica/Antarctica";
		case "BV": return "Antarctica/Bouvet Island";
		case "TF": return "Antarctica/French Southern Territories";
		case "HM": return "Antarctica/Heard Island and McDonald Islands";
		case "GS": return "Antarctica/South Georgia and the South Sandwich Islands";
		case "AF": return "Asia/Afghanistan";
		case "AM": return "Asia/Armenia";
		case "AZ": return "Asia/Azerbaijan";
		case "BH": return "Asia/Bahrain";
		case "BD": return "Asia/Bangladesh";
		case "BT": return "Asia/Bhutan";
		case "IO": return "Asia/British Indian Ocean Territory";
		case "BN": return "Asia/Brunei";
		case "KH": return "Asia/Cambodia";
		case "CN": return "Asia/China";
		case "CC": return "Asia/Cocos [Keeling] Islands";
		case "GE": return "Asia/Georgia";
		case "JO": return "Asia/Hashemite Kingdom of Jordan";
		case "HK": return "Asia/Hong Kong";
		case "IN": return "Asia/India";
		case "ID": return "Asia/Indonesia";
		case "IR": return "Asia/Iran";
		case "IQ": return "Asia/Iraq";
		case "IL": return "Asia/Israel";
		case "JP": return "Asia/Japan";
		case "KZ": return "Asia/Kazakhstan";
		case "KW": return "Asia/Kuwait";
		case "KG": return "Asia/Kyrgyzstan";
		case "LA": return "Asia/Laos";
		case "LB": return "Asia/Lebanon";
		case "MO": return "Asia/Macao";
		case "MY": return "Asia/Malaysia";
		case "MV": return "Asia/Maldives";
		case "MN": return "Asia/Mongolia";
		case "MM": return "Asia/Myanmar";
		case "NP": return "Asia/Nepal";
		case "KP": return "Asia/North Korea";
		case "OM": return "Asia/Oman";
		case "PK": return "Asia/Pakistan";
		case "PS": return "Asia/Palestine";
		case "PH": return "Asia/Philippines";
		case "QA": return "Asia/Qatar";
		case "SA": return "Asia/Saudi Arabia";
		case "SG": return "Asia/Singapore";
		case "KR": return "Asia/South Korea";
		case "LK": return "Asia/Sri Lanka";
		case "SY": return "Asia/Syria";
		case "TW": return "Asia/Taiwan";
		case "TJ": return "Asia/Tajikistan";
		case "TH": return "Asia/Thailand";
		case "TR": return "Asia/Turkey";
		case "TM": return "Asia/Turkmenistan";
		case "AE": return "Asia/United Arab Emirates";
		case "UZ": return "Asia/Uzbekistan";
		case "VN": return "Asia/Vietnam";
		case "YE": return "Asia/Yemen";
		case "AL": return "Europe/Albania";
		case "AD": return "Europe/Andorra";
		case "AT": return "Europe/Austria";
		case "BY": return "Europe/Belarus";
		case "BE": return "Europe/Belgium";
		case "BA": return "Europe/Bosnia and Herzegovina";
		case "BG": return "Europe/Bulgaria";
		case "HR": return "Europe/Croatia";
		case "CY": return "Europe/Cyprus";
		case "CZ": return "Europe/Czechia";
		case "DK": return "Europe/Denmark";
		case "EE": return "Europe/Estonia";
		case "FO": return "Europe/Faroe Islands";
		case "FI": return "Europe/Finland";
		case "FR": return "Europe/France";
		case "DE": return "Europe/Germany";
		case "GI": return "Europe/Gibraltar";
		case "GR": return "Europe/Greece";
		case "GG": return "Europe/Guernsey";
		case "HU": return "Europe/Hungary";
		case "IS": return "Europe/Iceland";
		case "IE": return "Europe/Ireland";
		case "IM": return "Europe/Isle of Man";
		case "IT": return "Europe/Italy";
		case "JE": return "Europe/Jersey";
		case "XK": return "Europe/Kosovo";
		case "LV": return "Europe/Latvia";
		case "LI": return "Europe/Liechtenstein";
		case "LU": return "Europe/Luxembourg";
		case "MT": return "Europe/Malta";
		case "MC": return "Europe/Monaco";
		case "ME": return "Europe/Montenegro";
		case "NL": return "Europe/Netherlands";
		case "MK": return "Europe/North Macedonia";
		case "NO": return "Europe/Norway";
		case "PL": return "Europe/Poland";
		case "PT": return "Europe/Portugal";
		case "LT": return "Europe/Republic of Lithuania";
		case "MD": return "Europe/Republic of Moldova";
		case "RO": return "Europe/Romania";
		case "RU": return "Europe/Russia";
		case "SM": return "Europe/San Marino";
		case "RS": return "Europe/Serbia";
		case "SK": return "Europe/Slovakia";
		case "SI": return "Europe/Slovenia";
		case "ES": return "Europe/Spain";
		case "SJ": return "Europe/Svalbard and Jan Mayen";
		case "SE": return "Europe/Sweden";
		case "CH": return "Europe/Switzerland";
		case "UA": return "Europe/Ukraine";
		case "GB": return "Europe/United Kingdom";
		case "VA": return "Europe/Vatican City";
		case "AX": return "Europe/Åland";
		case "AI": return "North America/Anguilla";
		case "AG": return "North America/Antigua and Barbuda";
		case "AW": return "North America/Aruba";
		case "BS": return "North America/Bahamas";
		case "BB": return "North America/Barbados";
		case "BZ": return "North America/Belize";
		case "BM": return "North America/Bermuda";
		case "BQ": return "North America/Bonaire, Sint Eustatius, and Saba";
		case "VG": return "North America/British Virgin Islands";
		case "CA": return "North America/Canada";
		case "KY": return "North America/Cayman Islands";
		case "CR": return "North America/Costa Rica";
		case "CU": return "North America/Cuba";
		case "CW": return "North America/Curaçao";
		case "DM": return "North America/Dominica";
		case "DO": return "North America/Dominican Republic";
		case "SV": return "North America/El Salvador";
		case "GL": return "North America/Greenland";
		case "GD": return "North America/Grenada";
		case "GP": return "North America/Guadeloupe";
		case "GT": return "North America/Guatemala";
		case "HT": return "North America/Haiti";
		case "HN": return "North America/Honduras";
		case "JM": return "North America/Jamaica";
		case "MQ": return "North America/Martinique";
		case "MX": return "North America/Mexico";
		case "MS": return "North America/Montserrat";
		case "NI": return "North America/Nicaragua";
		case "PA": return "North America/Panama";
		case "PR": return "North America/Puerto Rico";
		case "BL": return "North America/Saint Barthélemy";
		case "LC": return "North America/Saint Lucia";
		case "MF": return "North America/Saint Martin";
		case "PM": return "North America/Saint Pierre and Miquelon";
		case "VC": return "North America/Saint Vincent and the Grenadines";
		case "SX": return "North America/Sint Maarten";
		case "KN": return "North America/St Kitts and Nevis";
		case "TT": return "North America/Trinidad and Tobago";
		case "TC": return "North America/Turks and Caicos Islands";
		case "VI": return "North America/U.S. Virgin Islands";
		case "US": return "North America/United States";
		case "AS": return "Oceania/American Samoa";
		case "AU": return "Oceania/Australia";
		case "CX": return "Oceania/Christmas Island";
		case "CK": return "Oceania/Cook Islands";
		case "TL": return "Oceania/Democratic Republic of Timor-Leste";
		case "FM": return "Oceania/Federated States of Micronesia";
		case "FJ": return "Oceania/Fiji";
		case "PF": return "Oceania/French Polynesia";
		case "GU": return "Oceania/Guam";
		case "KI": return "Oceania/Kiribati";
		case "MH": return "Oceania/Marshall Islands";
		case "NR": return "Oceania/Nauru";
		case "NC": return "Oceania/New Caledonia";
		case "NZ": return "Oceania/New Zealand";
		case "NU": return "Oceania/Niue";
		case "NF": return "Oceania/Norfolk Island";
		case "MP": return "Oceania/Northern Mariana Islands";
		case "PW": return "Oceania/Palau";
		case "PG": return "Oceania/Papua New Guinea";
		case "PN": return "Oceania/Pitcairn Islands";
		case "WS": return "Oceania/Samoa";
		case "SB": return "Oceania/Solomon Islands";
		case "TK": return "Oceania/Tokelau";
		case "TO": return "Oceania/Tonga";
		case "TV": return "Oceania/Tuvalu";
		case "UM": return "Oceania/U.S. Minor Outlying Islands";
		case "VU": return "Oceania/Vanuatu";
		case "WF": return "Oceania/Wallis and Futuna";
		case "AR": return "South America/Argentina";
		case "BO": return "South America/Bolivia";
		case "BR": return "South America/Brazil";
		case "CL": return "South America/Chile";
		case "CO": return "South America/Colombia";
		case "EC": return "South America/Ecuador";
		case "FK": return "South America/Falkland Islands";
		case "GF": return "South America/French Guiana";
		case "GY": return "South America/Guyana";
		case "PY": return "South America/Paraguay";
		case "PE": return "South America/Peru";
		case "SR": return "South America/Suriname";
		case "UY": return "South America/Uruguay";
		case "VE": return "South America/Venezuela";
	}
}
