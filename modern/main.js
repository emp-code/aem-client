...
function displayMsg(isHistory, isInt, num) {
	...
	if (!isInt || ae.getIntMsgType(num) !== "system") {
		...
		document.getElementById("btn_reply").onclick = function() {
			...
			if (!document.getElementById("write_subj").value.toLowerCase().startsWith("re:")) document.getElementById("write_subj").value = "Re: " + document.getElementById("write_subj").value;
